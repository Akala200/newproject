                            ...
                            <ul className={`navbar-nav menu ml-auto ${nClass}`}>
                                ...
                                <li className="dropdown submenu nav-item">
                                    ...
                                    <ul role="menu" className=" dropdown-menu">
                                        <li className="nav-item"><NavLink exact title="Service" className="nav-link" to='/Service'>Local Purchase </NavLink></li>
                                        <li className="nav-item"><NavLink exact title="Service Details" className="nav-link" to='/ServiceDetails'>Foreign Purchase </NavLink></li>
                                    </ul>
                                </li>
                                <li className="nav-item dropdown submenu">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li className="nav-item"><NavLink to="/BlogSingle" className="nav-link">Blog Single</NavLink></li> <li className="nav-item"><NavLink exact title="About" className="nav-link" to='/About'>About</NavLink></li>
                                ...
                                <li className="dropdown submenu nav-item">
                                    <Link to="/SignUp" title="Pages" className="nav-link"  role="button" aria-haspopup="true" aria-expanded="false">Vendor Signup</Link>
                                </li>
                                <li className="dropdown submenu nav-item"><Link title="Pages" className="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" to="#">User Signup</Link>
                                    <ul role="menu" className=" dropdown-menu">
